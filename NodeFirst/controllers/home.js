...
var app = express();
function getFile(request, response, file) {
	fs.readFile(path.join(__dirname, '../Views/', file), 'utf8', function(err,
			data) {
		if (err) {
			throw err;
		}
...
exports.process = function(request, response) {
	...
	getFile(request, response, 'Home.htm');
};
...
app.post('/file-upload', function(req, response) {
//	  // get the temporary location of the file
//    var tmp_path = req.files.file.path;
//    // set where the file should actually exists - in this case it is in the "images" directory
//    var target_path = 'C:/Users/Nishikant/workspace/NodeFirst/Uploads/' + req.files.thumbnail.name;
